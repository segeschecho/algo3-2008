...
Notar que si s es mas larga que la palabra mas larga definida, vamos a parar por llegar a una hoja. Si en cambio s era mas corta, vamos a parar porque se nos acaba s (podriamos llegar a una hoja al mismo timepo), pero en ambos casos, vamos a parar en O(long_{max}) iteraciones.
