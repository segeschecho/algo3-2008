...
Por otro lado, podemos ver que para que exista un ganador es necesario que si participan n jugadores, la cantidad de partidos arrelgados sea como mínimo n - 1, ya que con menos partidos, necesariamente quedan jugadores sin un partido arreglado. De modo que obtenemos una caracteristica que permite resolver un tipo de instancia particular muy facilmente.
...
le gane a todos los del ciclo, y luego hacemos que a le gane a b. Análogamente se puede ver que si alguien del ciclo, le gana a 
