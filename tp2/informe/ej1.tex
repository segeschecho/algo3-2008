...
podemos hacer que 11 le gane a 6, 7 a 11 y por último 4 a 7. Es por esta razón que decimos que si 
alguien le gana a un jugador de una componente fuertemente conexa, se puede armar el torneo para 
que le gane a todos ellos. Una vez que el 4 eliminó a la componente rosa, es fácil ver que podemos 
armar un fixture para que cualquiera de su componente gane. Por ejemplo, armémoslo para el 2:
\begin{enumerate}
...
\item 2 le gana al 4
\end{enumerate}
Entonces si bien 2 no le ganaba a ningún jugador de la componente rosa, ni de ninguna otra componente, 
como había jugadores en su propia componente que les ganaban, pudimos arreglar el torneo para que el 2
salga victorioso.
