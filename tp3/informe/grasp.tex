...
combinación \textit{$\alpha$ adaptativa, primera posición y parada adaptativa} se mostró como una buena 
opción, tanto a nivel de mejora en la cantidad de cruces, como a nivel de tiempo de ejecución.

% FIXME: esto y otras cosas posiblemente se deban a q el rand() andaba mal :D
...
Finalmente esos son los parámetros que decidimos utilizar.
...
\STATE nuevoDibujo $\leftarrow$ construir un dibujo con la heuristica constructiva randomizada con $\alpha$, y aplicar busqueda local
