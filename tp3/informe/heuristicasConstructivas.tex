...
\begin{figure}[H]
\centering
\includegraphics[scale=0.50]{./graficos/comparcionInsercionNodos/exp2.png}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.70]{./graficos/comparcionInsercionNodos/exp1.png} 
\end{figure}
...
\subsubsection{ n nodos en cada partición con n creciente. Cantidad de ejes = $\frac{n^2}{2}$. Porcentaje de nodos nuevos: 60\%}

\setcounter{subfigure}{0}
\begin{figure}[H]
\centering
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/cruces1.png}}
\caption{Cantidad de cruces producidos en funcion de n}
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/tiempos1.png} }
\caption{Tiempo en segundos en función de n}
\end{figure}

\subsubsection{ n nodos en cada partición con n creciente. Cantidad de ejes = $\frac{n^2}{2}$. Porcentaje de nodos nuevos: 40\%}
\setcounter{subfigure}{0}
\begin{figure}[H]
\centering
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/cruces2.png}}
\caption{Cantidad de cruces producidos en funcion de n}
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/tiempos2.png} }
\caption{Tiempo en segundos en función de n}
\end{figure}

\subsubsection{ n nodos en cada partición con n creciente. Cantidad de ejes = 3n. Porcentaje de nodos nuevos: 60\%}
\setcounter{subfigure}{0}
\begin{figure}[H]
\centering
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/cruces3.png}}
\caption{Cantidad de cruces producidos en funcion de n}
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/tiempos3.png} }
\caption{Tiempo en segundos en función de n}
\end{figure}

\subsubsection{ n nodos en cada partición con n creciente. Cantidad de ejes = 3n. Porcentaje de nodos nuevos: 40\%}
\setcounter{subfigure}{0}
\begin{figure}[H]
\centering
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/cruces4.png}}
\caption{Cantidad de cruces producidos en funcion de n}
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/tiempos4.png} }
\caption{Tiempo en segundos en función de n}
\end{figure}

\subsubsection{ n = 30. Cantidad de ejes creciente. Porcentaje de nodos nuevos: 40\%}
\setcounter{subfigure}{0}
\begin{figure}[H]
\centering
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/cruces5.png}}
\caption{Cantidad de cruces producidos en funcion de m}
\subfigure[]{
\includegraphics[scale=0.5]{./graficos/comparacionConstructivas/tiempos5.png} }
\caption{Tiempo en segundos en función de m}
\end{figure}
