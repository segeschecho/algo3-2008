...
aquellos en los que todos los nodos del PATRICIA tienen 26 hijos, ya que de esta forma se utiliza la mayor cantidad de memoria por nodo. Dado que una lista doblemente enlazada de 26 elementos deber'ia 
ocupar mas que un arreglo de 26 punteros, inmediatamente tendemos a concluir que un PATRICIA completo (26 hijos cada nodo)
deber'ia ocupar m'as memoria sobre listas que sobre arreglos, pero no es as'i, pues debemos recordar que las hojas del 
...
considerarse, pese a que es m'as lenta, la implementaci'on con listas por sobre la de arreglos.
