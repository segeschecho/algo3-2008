...
Por ejemplo veamos en la figura \ref{fig:reduccion}, la parte a. Una componente fuertemente conexa es 6,7,11. Por otro lado el 4 le gana al 6. Entonces podemos hacer que 7 le gane a 11, 6 haga lo propio con 7 y luego que 4 le gane 6, por lo cual 4 pudo vencer (no en sentido estricto, sino en que todos quedaron elminados). Si en vez de que $4\leadsto 6$, hubiesemos tenido que  $4\leadsto 7$, podemos hacer que 11 le gane a 6, 7 a 11 y por ultimo 4 a 7. Es por esta razon que decimos que si alguien le gana a un jugador de una componente fuertemente conexa, se pude armar el torneo para que le gane a todos ellos. Una vez que el cuatro elimino a la componente rosa, es facil ver que podemos armar un fixture para que cualqueria de su componente gane, por ejemplo armemoslo para el 2:
\begin{enumerate}
...
\item 2 le gana al 4
\end{enumerate}
Entonces si bien 2 no le ganaba a ningún jugador de la componente rosa, ni de ninguna otra componente, como habia jugadores en su propia componente que les ganaban, pudimos arreglar un torneo, para que el puede ganarles.
%TODO: amplie la explicacion, ver si se entiende.
