...
\centering
\setcounter{subfigure}{0}
\includegraphics[scale=0.50]{./graficos/comparacionInsercionNodos/exp2.png}
\end{figure}

\begin{figure}[H]
\centering
\setcounter{subfigure}{0}
\includegraphics[scale=0.70]{./graficos/comparacionInsercionNodos/exp1.png} 
\end{figure}
...
\includegraphics[scale=0.6]{./graficos/comparacionConstructivas/cruces1.png}}
\setcounter{subfigure}{1}
\subfigure[Tiempo en segundos en función de n]{
\includegraphics[scale=0.6]{./graficos/comparacionConstructivas/tiempos1.png} }
\end{figure}
