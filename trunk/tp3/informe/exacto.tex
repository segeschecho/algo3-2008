...
$$O(moviles_1!*moviles_1!*\dbinom{moviles_1 + fijos_1}{fijos_1}(v_1+m+v_{1}^2)*(moviles_1+ moviles_2!*\dbinom{moviles_2 + fijos_2}{fijos_2} * $$
$$(v_2+m+v_{2}^2)*(moviles_2 + (v_1+v_2)) + v_2*v_{max}) + V_1 + V_2 + m*log(v_max))$$

Y usando que:
 $$moviles_1!*\dbinom{moviles_1 + fijos_1}{fijos_1} = \frac{(moviles_1 + fijos_1)!}{fijos_1!} $$ :

tenemos que:
$$O(\frac{(moviles_1 + fijos_1)!}{fijos_1!} * (v_1+m+v_{1}^2)*(moviles_1+ \frac{(moviles_2 + fijos_2)!}{fijos_2!} *$$
$$(v_2+m+v_{2}^2)*(moviles_2 + (v_1+v_2)) + v_2*v_{max}) + V_1 + V_2 + m*log(v_max))$$ 
