...
Para medir los tiempo se utiliz'o una clase basada en QueryPerformanceCounter de windwos. Para contar operaciones, el procedimiento se baso en declarar unavariable global e ir incrementandola en base a las operaciones que se realizaban linea a linea. Este procedimiento se aplico en los tres ejercicios.
