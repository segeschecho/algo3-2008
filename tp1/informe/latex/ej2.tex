...
A medida que se va armando una soluci'on, son descartadas aquellas cuyo peso excede la capacidad del cami'on, y de esta manera se va podando el 'arbol de posibles soluciones.
...
$$T(0) = N + 1$$
$$T(n) = 2*T(n-1) + k$$
$k$ viene de las operaciones que se realizan dentro de cada llamada, las cuales son todas O(1).
...
na mejora en la pr'actica contrastamos los resultados entre el algoritmo sin podas, y el algoritmo con podas. Para hacer 
