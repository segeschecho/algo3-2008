...
Sea $N$ la cantidad de cosas que hay para elegir. Observemos que dado un $N$, si llamamos $n$ a la cantidad 
de elementos que me quedan por procesar (es decir por decidir si llevo o no), la 
%FIXME: wtf paso aca??
