...
Consideramos que si bien estas podas no nos mejorar'an el orden de complejidad, si nos permitirian en general observar un mejor desempeño.
...
Luego el algoritmo tiene un orden exponencial en funcion del tamaño de la entrada, aun pese a las podas; y esto es de esperarse ya que las podas funcionan en algunos casos, mientras que en otros no ayudan en nada. 
